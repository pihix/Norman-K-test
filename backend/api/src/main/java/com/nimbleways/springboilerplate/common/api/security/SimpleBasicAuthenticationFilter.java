...
public class SimpleBasicAuthenticationFilter implements Filter {
    ...
    public static final BasicAuthenticationConverter BASIC_AUTHENTICATION_CONVERTER =
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain)
        ...
        if (!isAuthorized(httpRequest)) {
            String headerValue =
                "%s realm=\"%s\"".formatted(BasicAuthenticationConverter.AUTHENTICATION_SCHEME_BASIC, realm);
