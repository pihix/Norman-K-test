...
public class HexagonalArchitectureRulesUnitTests {
    ...
    @ArchTest
    static final ArchRule subdomains_should_depend_only_on_common_utils_and_common_domain_and_java_libraries_with_few_exceptions =
        classes()
            .that()
    ...
    @ArchTest
    static final ArchRule common_domain_should_depend_only_on_common_utils_and_java_libraries_with_few_exceptions =
        classes()
            .that()
            .resideInAPackage("..common.domain..")
            .should()
            .onlyDependOnClassesThat(
                resideInAnyPackage(
                    "..common.domain..",
    ...
    static final ArchRule fields_should_use_port_type_instead_of_adapter = fields()
        ...
        .haveRawType(
            DescribedPredicate.describe(
                "of the port interface instead of the adapter's",
                t ->
                    t.isInterface() ||
                    t
                        .toErasure()
                        .getAllRawInterfaces()
                        .stream()
                        .noneMatch(i -> i.getFullName().contains(".domain.ports."))
            )
        );
